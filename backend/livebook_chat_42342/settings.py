"""
Django settings for livebook_chat_42342 project.
...
ROOT_URLCONF = 'livebook_chat_42342.urls'
...
WSGI_APPLICATION = 'livebook_chat_42342.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "livebook_chat_42342 API",
    "DESCRIPTION": "API documentation for livebook_chat_42342 App",
    "VERSION": "v1",
}
